...
output1_filename = '2human_cmaes';
output2_filename = '2mouse_cmaes';
fig_filename = 'H2-M2_cmaes';
...
human_min_iou = 0.7;
mouse_min_iou = 0.7;
output1_filename = '2human_cmaes_threshold';
output2_filename = '2mouse_cmaes_threshold';
fig_filename = 'H2-M2_cmaes_threshold';
