...
output1_filename = 'human1_cmaes';
output2_filename = 'human2_cmaes';
fig_filename = 'H1-H2_cmaes';
...
human_min_iou = 0.7;
mouse_min_iou = 0.7;
output1_filename = 'human1_cmaes_threshold';
output2_filename = 'human2_cmaes_threshold';
fig_filename = 'H1-H2_cmaes_threshold';
