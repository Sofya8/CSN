...
output1_filename = '3human_cmaes';
output2_filename = '3mouse_cmaes';
fig_filename = 'H1-M2_cmaes';
...
human_min_iou = 0.7;
mouse_min_iou = 0.7;
output1_filename = '3human_cmaes_threshold';
output2_filename = '3mouse_cmaes_threshold';
fig_filename = 'H1-M2_cmaes_threshold';
