...
output1_filename = '1human_cmaes';
output2_filename = '1mouse_cmaes';
fig_filename = 'H1-M1_cmaes';
...
human_min_iou = 0.7;
mouse_min_iou = 0.7;
output1_filename = '1human_cmaes_threshold';
output2_filename = '1mouse_cmaes_threshold';
fig_filename = 'H1-M1_cmaes_threshold';
